...
implements SpeechletV2
{
	...
	public static String gardenerbeschr = "The gardener is a very simple-minded man. He seems to have been doing his job well for many years. He is said to have been in love with the lady many years ago. Well, in any case he loves his daughter, the maid, more than anything and would probably do anything for her";
	...
	public static int wasfragst(String userRequest) {
		...
		//andere alexa-Funktionen, die uns nicht interessieren
		@Override
		...
		{
			tutorial(1);
			return speak("Willkommen bei MuderMistery","narrator");
			}
